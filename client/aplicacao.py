...
#                                 print("Deu tempo menor ou igual a 20")
#                                 rxBuffer, nRx = self.com.getData(14)
...
#                     else:                        
#                         rxBuffer, nRx = self.com.getData(14)
#                         print("Trouxe rxBuffer do tipo 4")
#                         self.atualiza_arquivo(tipo=rxBuffer[0], tamanho=nRx, envio=False)
#                         if rxBuffer[0] == 4:
#                             print("De fato é do tipo 4")
#                             if self.erro_ordem == True: 
#                                 self.num_pacote -= 1
#                             else:
#                                 print("Tá na ordem certa")
#                                 if self.num_pacote == self.num_total:
#                                     self.disable()
#                                 self.num_pacote += 1
#                                 print(f"Incrementou o num_pacote: {self.num_pacote}")
#                                 enviado = True
#                                 msg_correta = True
#                         # else: ...
#         if self.num_pacote == self.num_total:
